 ...
 * @author hp
 */
@WebServlet(name="DeleteCategoryServlet", urlPatterns={"/deletecate"})
public class DeleteCategoryServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if(d.checkCategoryExist(id)){
            String mess = "Thể loại này đang được sử dụng cho sản phẩm!!!";
        ...
        request.getRequestDispatcher("dashboardc").forward(request, response);
    } 
