 ...
 * @author canduykhanh
 */
@WebServlet(name="SearchListProductByDiscount", urlPatterns={"/searchByDiscount"})
public class SearchListProductByDiscount extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SearchListProductByDiscount</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SearchListProductByDiscount at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if (totalRow == 0) {
            ...
            List<Product> listP = shopDAO.getAllProductPresentationPagingByDiscountDes(pageIndex, pageSize);
        ...
        request.setAttribute("isDiscount", "isDiscount");
