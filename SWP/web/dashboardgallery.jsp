    ...
    <head>
        ...
        <script type="text/javascript">
            function doDelete(gid) {
                if (confirm("Are you sure to delete thumbnail with id=" + gid)) {
                    window.location = "deleteg?gid=" + gid;
                }
            }
        </script>
                            ...
                            <form action="delete" method="get">
                                <div class="row mb-6 align-items-center">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <h2 class="fs-24 mb-0">Bảng danh sách hình ảnh</h2>
                                        <p class="mb-0"></p>
                                    </div>                                  
                                                ...
                                                <table class="table align-middle table-nowrap mb-0">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-secondary align-middle font-weight-bold">Product ID</td>
                                                            <td class="text-secondary align-middle font-weight-bold">Thumbnail</td>
                                                            <td></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class=" pt-6 ">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <p class="font-weight-600 text-secondary mb-0">${g.id}</p>
                                                                ...
                                                                <td class=" pt-6 ">
                                                                        ...
                                                                        <div class="media-body">
                                                                            ...
                                                                            <p class="font-weight-600 text-secondary mb-0">${g.product_id}</p>
                                                                        </div>
                                                                   
                                                                </td>
                                                                
                                                                
                                                                <td><img style="height: 100px; width: 100px" src="${g.thumbnail}" alt="alt"/></td>
                                                                ...
                                                                <td class="align-middle">
                                                                    <div class="d-flex flex-wrap justify-content-end">
                                                                        <a href="editg?gid=${g.id}" class="btn btn-primary btn-sm mr-1 my-1"><i class="fal fa-pen"></i><span class="d-inline-block ml-1">Chỉnh sửa</span></a>
                                                                        <a href="#" onclick="doDelete('${g.id}')" class="btn btn-sm border hover-white bg-hover-primary mr-1 border-primary my-1 text-secondary font-weight-400"><i class="fas fa-trash-alt"></i><span class="d-inline-block ml-1">Xóa</span></a>
