                                    ...
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="mb-4">
                                                        <input hidden="" type="text" name="id" value="${cate.id}" class="form-control bg-input border-0" id="product-title">
                                                        <input hidden="" type="text" name="old" value="${cate.name}" class="form-control bg-input border-0" id="product-title">
                                                        <label class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase" for="product-title">Tên thể loại</label>
                                                        <input required type="text" name="name" value="${cate.name}" class="form-control bg-input border-0" id="product-title">
                                                    </div>
