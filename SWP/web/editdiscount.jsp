            ...
            <div class="d-flex flex-wrap flex-xl-nowrap">
                ...
                <div class="page-content">
                    ...
                    <main id="content" class="bg-gray-01 d-flex flex-column main-content">
                        ...
                        <form action="editd" method="get">
                        <div class="dashboard-page-content">
                            <div class="row">
                                <div class="col-xxl-6">
                                    <div class="row mb-6">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <h2 class="fs-24 mb-0">Thêm mã giảm giá</h2>
                                            <br>
                                    ...
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="mb-4">
                                                        <input hidden="" type="text" name="id" value="${discount.id}" class="form-control bg-input border-0" id="product-title">
                                                        <input hidden="" type="text" name="old" value="${discount.value}" class="form-control bg-input border-0" id="product-title">
                                                        <label class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase" for="product-title">Mã giảm giá</label>
                                                        <input required type="number" name="discount" value="${discount.value}" class="form-control bg-input border-0" id="product-title">
                                                    </div>
