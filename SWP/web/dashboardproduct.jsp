                            ...
                            <nav aria-label="Page navigation example" class="mt-6 mb-4">
                                ...
                                <ul class="pagination justify-content-start">
                                    ...
                                    <li class="page-item mx-1">
                                        <a class="page-link" href="dashboardp?pageIndex=${backPage}"><i class="far fa-chevron-left"></i></a>
                                    </li>
                                    </c:if>
                                    
                                    <c:forEach begin="1" end="${maxPage}" step="1" var="i">
                                        <li class="page-item ${i==pageIndex?"active":""} mx-1"><a class="page-link" href="dashboardp?pageIndex=${i}">${i}</a></li>         
                                    </c:forEach> 
                                        <c:if test="${nextPage<maxPage+1}">
                                    <li class="page-item mx-1">
                                        <a class="page-link" href="dashboardp?pageIndex=${nextPage}"><i class="far fa-chevron-right"></i></a>
                                    </li>
                                       </c:if>
                                </ul>
                                </c:if>
