...
<html lang="en">
    ...
    <!-- Mirrored from templates.g5plus.net/glowing/dashboard/review.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Feb 2023 07:47:27 GMT -->
                        ...
                        <div class="dashboard-page-content">
                            <div class="row mb-6 align-items-center">
                                <div class="col-sm-9 mb-3 mb-sm-0">
                                    <h2 class="fs-24 mb-0">Danh sách đánh giá</h2>
                                    <p class="mb-0">Dựa theo các sản phẩm.</p>
                                </div>
                            </div>
                            <c:if test="${requestScope.msg != null}">
                                <h2 class="fs-24 mb-0">${requestScope.msg}</h2>
                            </c:if>
                            <c:if test="${requestScope.msg == null}">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="table-responsive">
                                            <table class="table table-hover align-middle table-nowrap mb-0 table-borderless">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${requestScope.listFeedback}" var="lF">
                                                        <tr>
                                                            <td>${lF.id}</td>
                                ...
                                <ul class="pagination justify-content-start">
                                    ...
                                    <li class="page-item mx-1">
                                        <c:if test="${param.page!=1}">
                                            <a class="page-link" href="feedbacklist?page=${param.page-1}">
                                                <i class="far fa-chevron-left"></i>
                                            </a>
                                        </c:if>

                                    </li>
                                    <li class="page-item active mx-1"><a class="page-link" href="feedbacklist?page=${param.page}">${param.page}</a></li>
