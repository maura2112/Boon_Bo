<%-- 
    Document   : managecolor
    Created on : Nov 6, 2022, 10:50:21 PM
    Author     : hp
--%>
...
<html lang="en">
    ...
    <body>   
                    ...
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-7">                     
                                ...
                                <a style="background-color: #bbb" href="#managecolor" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Color</span></a> 
        ...
        <!-- Edit Modal HTML -->
        <div id="managecolor" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="addcolor" method="get">
