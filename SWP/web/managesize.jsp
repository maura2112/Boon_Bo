<%-- 
    Document   : managesize
    Created on : Nov 6, 2022, 11:35:29 PM
    Author     : hp
--%>
...
<html lang="en">
    ...
    <body>   
                    ...
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-7">                                
                                ...
                                <a style="background-color: #bbb" href="#managesize" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Size</span></a> 
                            </div>
        ...
        <!-- Edit Modal HTML -->
        <div id="managesize" class="modal fade">
