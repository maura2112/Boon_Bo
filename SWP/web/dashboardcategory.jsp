    ...
    <head>
        ...
        <script type="text/javascript">
            function doDelete(cid) {
                if (confirm("Are you sure to delete category with id=" + cid)) {
                    window.location = "deletecate?cid=" + cid;
                }
            }
        </script>
                            ...
                            <form action="delete" method="get">
                                <div class="row mb-6 align-items-center">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <h2 class="fs-24 mb-0">Bảng danh sách thể loại</h2>
                                        <br>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="align-middle">
                                                                    <div class="d-flex flex-wrap justify-content-end">
                                                                        <a href="editcate?cid=${c.id}" class="btn btn-primary btn-sm mr-1 my-1"><i class="fal fa-pen"></i><span class="d-inline-block ml-1">Chỉnh sửa</span></a>
                                                                        <a href="#" onclick="doDelete('${c.id}')" class="btn btn-sm border hover-white bg-hover-primary mr-1 border-primary my-1 text-secondary font-weight-400"><i class="fas fa-trash-alt"></i><span class="d-inline-block ml-1">Xóa</span></a>
