                                    ...
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="mb-4">
                                                        <label class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase" for="product-title">ID</label>
                                                        <input readonly type="text" name="id" value="${gallery.id}" class="form-control bg-input border-0" id="product-title">
                                                        <label class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase" for="product-title">ID Sản phẩm</label>
                                                        <input readonly type="number" name="pid" value="${gallery.product_id}" class="form-control bg-input border-0" id="product-title">
                                                        <label class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase" for="product-title">Hình ảnh</label>
                                                        <input required type=file name="thumbnail" class="form-control bg-input border-0" id="product-title">
                                                    </div>
