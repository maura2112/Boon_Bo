<%-- 
    Document   : managecapacity
    Created on : Nov 6, 2022, 11:27:06 PM
    Author     : hp
--%>
...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            function doDelete(id) {
                if (confirm("Are you sure to delete capacity with id=" + id)) {
                    window.location = "deletecapacity?id=" + id;
                }
            }
        </script>
    ...
    <body>   
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-5">
                                <h2>Manage <b>Color</b></h2>
                            </div>
                            <div class="col-sm-7">          
                                <a style="background-color: #bbb" href="manageproduct" class="btn btn-success" > <span>Product</span></a> 
                                <a style="background-color: #bbb" href="managecolor" class="btn btn-success" > <span>Color</span></a> 
                                <a style="background-color: #bbb" href="#managecapacity" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Capacity</span></a> 
        ...
        <!-- Edit Modal HTML -->
        <div id="managecapacity" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="addcapacity" method="get">
