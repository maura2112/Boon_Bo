    ...
    <head>
        ...
        <script type="text/javascript">
            function doDelete(sid) {
                if (confirm("Are you sure to delete size with id=" + sid)) {
                    window.location = "deletesize?id=" + sid;
                }
            }
        </script>
                ...
                <div class="page-content">
                    ...
                    <main id="content" class="bg-gray-01 d-flex flex-column main-content">
                        <div class="dashboard-page-content">
                            <form action="deletesize" method="get">
                                <div class="row mb-6 align-items-center">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <h2 class="fs-24 mb-0">Bảng danh sách dung tích</h2>
                                        <p class="mb-0"></p>
                                        <br>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="align-middle">
                                                                    <div class="d-flex flex-wrap justify-content-end">
                                                                        <a href="editsize?sid=${s.id}" class="btn btn-primary btn-sm mr-1 my-1"><i class="fal fa-pen"></i><span class="d-inline-block ml-1">Chỉnh sửa</span></a>
                                                                        <a href="#" onclick="doDelete('${s.id}')" class="btn btn-sm border hover-white bg-hover-primary mr-1 border-primary my-1 text-secondary font-weight-400"><i class="fas fa-trash-alt"></i><span class="d-inline-block ml-1">Xóa</span></a>
