            ...
            <div class="d-flex flex-wrap flex-xl-nowrap">
                ...
                <div class="page-content">
                    ...
                    <main id="content" class="bg-gray-01 d-flex flex-column main-content">
                        ...
                        <form action="addgallery" method="get">
                        <div class="dashboard-page-content">
                            <div class="row">
                                <div class="col-xxl-6">
                                    <div class="row mb-6">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <h2 class="fs-24 mb-0">Thêm hình ảnh</h2>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="mb-4">
                                                        ...
                                                        <input required type="number" name="id" placeholder="Type here" class="form-control bg-input border-0" id="product-title">
                                                    </div>
                                                    <div class="mb-4">
                                                        <label class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase" for="product-title">Hình ảnh</label>
                                                        <input required type="file" name="thumbnail" placeholder="Type here" class="form-control bg-input border-0" id="product-title">
                                                    </div>
                                                </div>
